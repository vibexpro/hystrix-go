...
[![GoDoc Documentation](http://godoc.org/github.com/vibexpro/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/vibexpro/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/vibexpro/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/vibexpro/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/vibexpro/hystrix-go```
- ```go test ./...```
